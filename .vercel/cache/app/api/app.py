...
if os.path.exists("Resources/merged_data.csv"):
    merged_df = pd.read_csv("Resources/merged_data.csv")
else:
    print(f"Error: File '{"Resources/merged_data.csv"}' not found.")
    # Handle the error as needed, maybe set merged_df to None or provide a default dataset
